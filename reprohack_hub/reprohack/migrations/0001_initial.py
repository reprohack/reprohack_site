    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(default=reprohack_hub.reprohack.models.default_event_start)),
                ('end_time', models.DateTimeField(default=reprohack_hub.reprohack.models.default_event_end)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors_and_submitters', models.ManyToManyField(through='reprohack.AuthorsAndSubmitters', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviewers', models.ManyToManyField(through='reprohack.PaperReviewer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='paperreviewer',
            name='review',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='reprohack.review'),
        ),
        migrations.AddField(
            model_name='paperreviewer',
            name='user',
