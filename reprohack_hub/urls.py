...
urlpatterns = [
    ...
    path('data_protection_and_privacy_policy',
         MarkdownView.as_view(extra_context={'title': 'Data Protection & Privacy Policy',
                                             'markdown_file': 'data_protection_and_privacy_policy.md'}),
         name='data_protection_and_privacy_policy'),
