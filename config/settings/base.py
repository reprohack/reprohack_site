...
"""
Send e-mail through standard SMTP serer. See [https://docs.djangoproject.com/en/3.2/topics/email/#smtp-backend](https://docs.djangoproject.com/en/3.2/topics/email/#smtp-backend)
